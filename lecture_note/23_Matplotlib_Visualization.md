...
이번 장을 마치면 여러분은 Matplotlib을 사용하여 데이터를 그래프로 시각화할 수 있습니다. 선 그래프, 막대 그래프, 원 그래프 등을 그려 데이터를 한눈에 이해하기 쉽게 표현할 수 있게 됩니다.
