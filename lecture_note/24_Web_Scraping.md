...
Some websites block requests from programs because they want to prevent automated access. To get around this, we can set a User-Agent header that makes our Python program look like a regular web browser. This is a common and legitimate practice, though you should always respect the website's terms of service.
...
# Set User-Agent header (User-Agent 헤더 설정)
headers = {
